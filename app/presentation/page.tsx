...
export default function Presentation() {
  return (
    <PageShell>
      ...
      <div className="mt-6 rounded-[2rem] bg-slate-950 p-7 text-white sm:flex sm:items-center sm:justify-between"><div><h2 className="text-2xl font-semibold">Prêt à découvrir tes tendances ?</h2><p className="mt-2 text-sm text-slate-400">Commence avec un fichier CSV ou quelques mesures manuelles.</p></div><Link href={ROUTES.import} className="mt-5 inline-flex rounded-2xl bg-white px-5 py-3 text-sm font-semibold text-slate-950 sm:mt-0">Commencer</Link></div>
    </PageShell>
  );
}
