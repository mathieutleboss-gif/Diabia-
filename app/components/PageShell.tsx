...
export function PageShell({ children, width = "max-w-6xl" }: { children: React.ReactNode; width?: string }) {
  return (
    <main className="relative min-h-[calc(100vh-65px)] overflow-hidden bg-[#f3f6fb]">
...
export function PageHero({ eyebrow, title, description, backHref = ROUTES.dashboard, backLabel = "Tableau de bord" }: { eyebrow: string; title: string; description: string; backHref?: string; backLabel?: string }) {
  return (
...
export const primaryButtonClassName = "inline-flex items-center justify-center rounded-2xl bg-slate-950 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-slate-900/15 transition hover:-translate-y-0.5 hover:bg-blue-700 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-blue-200 disabled:cursor-not-allowed disabled:opacity-50";
